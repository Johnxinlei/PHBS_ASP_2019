...
class ModelHagan:
    ...
    def calibrate3(self, price_or_vol3, strike3, spot, texp=None, cp_sign=1, setval=False, is_vol=True):
        ...
        if(is_vol):
            ...
            _vol[0] = self.bsm_model.impvol(_price[0], strike3[0], spot, texp, cp_sign= cp_sign)
            _vol[1] = self.bsm_model.impvol(_price[1], strike3[1], spot, texp, cp_sign= cp_sign)
            _vol[2] = self.bsm_model.impvol(_price[2], strike3[2], spot, texp, cp_sign= cp_sign)
        ...
        sol = sopt.root(fun,[2,2,0.3],method='hybr') 
...
class ModelNormalHagan:
    ...
    def calibrate3(self, price_or_vol3, strike3, spot, texp=None, cp_sign=1, setval=False, is_vol=True):
        ...
        if(is_vol):
            ...
            _price = price_or_vol3
            _vol[0] = self.normal_model.impvol(_price[0], strike3[0], spot, texp, cp_sign= cp_sign)
            _vol[1] = self.normal_model.impvol(_price[1], strike3[1], spot, texp, cp_sign= cp_sign)
            _vol[2] = self.normal_model.impvol(_price[2], strike3[2], spot, texp, cp_sign= cp_sign)
        ...
        sol = sopt.root(fun,[10,10,0.1],method='hybr') 
...
class ModelBsmMC:
    ...
    def __init__(self, texp, sigma, alpha=0, rho=0.0, beta=1.0, intr=0, divr=0,timestep = 120,n_sample = 1000):
        self.texp = texp
        self.sigma = sigma
        self.alpha = alpha
        self.rho = rho
    ...
    def price(self, strike, spot, texp=None, sigma=None, cp_sign=1,fix = True):
        '''
...
class ModelNormalMC:
    ...
    def __init__(self, texp, sigma, alpha=0, rho=0.0, beta=0.0, intr=0, divr=0,timestep = 1000,n_sample = 1000):
        self.texp = texp
        self.sigma = sigma
        self.alpha = alpha
        self.rho = rho
...
class ModelNormalCondMC:
    ...
    def __init__(self, texp, sigma, alpha=0, rho=0.0, beta=0.0, intr=0, divr=0, timestep = 120, n_sample = 1000):
        self.texp = texp
        self.sigma = sigma
        self.alpha = alpha
        self.rho = rho
